...
import { deleteNotification, listCustomerNotifications, markNotificationRead, unreadNotificationCount } from "../services/notification.service";
...
export const remove = asyncHandler(async (req, res) => {
  const notification = await deleteNotification(await customerId(req), req.params.id);
  if (!notification) throw ApiError.notFound("Notification not found");
