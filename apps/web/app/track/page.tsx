...
// Simulated mock data for demo tracking lookup
const MOCK_SHIPMENT = {
...
export default function TrackPage() {
  ...
  const handleTrack = (e: React.FormEvent) => {
    e.preventDefault();
    setHasSearched(true);
    // For demo purposes, any input triggers the active mock result
    if (query.trim() !== "") {
        ...
        {hasSearched && !activeShipment && (
          <div className="mx-auto mt-12 max-w-lg rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-sm">
            ...
            <p className="mt-2 text-xs text-gray-500">
              ...
              <code className="text-amber-600">PG-882940</code>) and try again.
            </p>
          </div>
        )}
      </Container>
