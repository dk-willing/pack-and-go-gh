...
const cargoCategories = [
  ...
  },
  {
    ...
    description: "Generators, machinery, and industrial loads that need the right vehicle.",
    weight: "bold" as const,
  },
  {
    title: "Oversized cargo",
    description: "Long, wide, or awkward loads planned with route and permit checks.",
    weight: "bold" as const,
  },
];
        ...
        <Container className="grid gap-12 py-20 lg:grid-cols-2 lg:items-center lg:py-28">
          <div>
            ...
            <p className="mt-6 text-lg text-ink-muted leading-relaxed max-w-prose">
              From a single parcel to oversized industrial equipment, Pack &amp; Go
              plans the route, assigns the right vehicle, and keeps you updated
              from pickup to proof of delivery.
            </p>
            <div className="mt-8 flex flex-wrap gap-4">
              <Button href="/request-delivery">Request a delivery</Button>
              <Button href="/track" variant="secondary">Track a shipment</Button>
            </div>
          </div>
              ...
              <Card key={category.title} weight={category.weight}>
                ...
                <p
                  className={`mt-2 text-sm leading-relaxed ${
                    category.weight === "bold" ? "text-paper/80" : "text-ink-muted"
                  }`}
                >
      ...
      <section className="py-20">
        <Container className="rounded-sm bg-navy-950 px-8 py-14 text-center sm:px-16">
          ...
          <p className="mt-4 text-paper/70 max-w-xl mx-auto">
            Tell us what you&apos;re shipping and where it needs to go — we&apos;ll
            handle the rest.
          </p>
          <div className="mt-8 flex justify-center gap-4">
            <Button href="/request-delivery" variant="secondary" className="border-paper/30 text-paper hover:border-paper">
              Request a delivery
            </Button>
          </div>
        </Container>
